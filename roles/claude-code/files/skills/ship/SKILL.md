---
name: ship
description: Validate code, create a Graphite branch, and submit a PR. Use when implementation is complete and ready to ship. Triggers on "ship it", "ready to submit", "create a PR", or when implementation is done.
allowed-tools: Bash, mcp__linear
---
